    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-background">
      <Card className="w-full max-w-md p-6 md:p-8">
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="font-bold text-xl">ListingShield</span>
        </div>
        <h1 className="text-2xl font-bold text-center mb-1">Start protecting your shop.</h1>
        <p className="text-sm text-muted-foreground text-center mb-6">7-day free trial, no credit card required.</p>
